...
class AIAgent:
    ...
    def _compress_context(self, messages: list, system_message: str, *, approx_tokens: int = None, task_id: str = "default", focus_topic: str = None, force: bool = False, status_message: str = None) -> tuple:
        ...
        return compress_context(
            ...
            force=force, status_message=status_message,
        )
